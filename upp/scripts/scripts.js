...
const locales = {
  // Americas
  ar: { ietf: 'es-AR', tk: 'oln4yqj.css', exl: 'es' },
  br: { ietf: 'pt-BR', tk: 'inq1xob.css', exl: 'pt-br', base: 'pt' },
  ca: { ietf: 'en-CA', tk: 'pps7abe.css', base: '' },
  ca_fr: { ietf: 'fr-CA', tk: 'vrk5vyv.css', exl: 'fr', base: 'fr' },
  cl: { ietf: 'es-CL', tk: 'oln4yqj.css', exl: 'es' },
  co: { ietf: 'es-CO', tk: 'oln4yqj.css', exl: 'es' },
  la: { ietf: 'es-DO', tk: 'oln4yqj.css', exl: 'es', base: 'es' },
  mx: { ietf: 'es-MX', tk: 'oln4yqj.css', exl: 'es' },
  pe: { ietf: 'es-PE', tk: 'oln4yqj.css', exl: 'es' },
  '': { ietf: 'en-US', tk: 'hah7vzn.css' },
  // EMEA
  africa: { ietf: 'en', tk: 'pps7abe.css', base: '' },
  be_fr: { ietf: 'fr-BE', tk: 'vrk5vyv.css', exl: 'fr', base: 'fr' },
  be_en: { ietf: 'en-BE', tk: 'pps7abe.css', base: '' },
  be_nl: { ietf: 'nl-BE', tk: 'cya6bri.css', exl: 'nl' },
  cy_en: { ietf: 'en-CY', tk: 'pps7abe.css' },
  dk: { ietf: 'da-DK', tk: 'aaz7dvd.css', base: '' },
  de: { ietf: 'de-DE', tk: 'vin7zsi.css', exl: 'de' },
  ee: { ietf: 'et-EE', tk: 'aaz7dvd.css', base: '' },
  es: { ietf: 'es-ES', tk: 'oln4yqj.css', exl: 'es' },
  fr: { ietf: 'fr-FR', tk: 'vrk5vyv.css', exl: 'fr' },
  gr_en: { ietf: 'en-GR', tk: 'pps7abe.css', base: '' },
  ie: { ietf: 'en-GB', tk: 'pps7abe.css', base: '' },
  il_en: { ietf: 'en-IL', tk: 'pps7abe.css', base: '' },
  it: { ietf: 'it-IT', tk: 'bbf5pok.css', exl: 'it' },
  lv: { ietf: 'lv-LV', tk: 'aaz7dvd.css' },
  lt: { ietf: 'lt-LT', tk: 'aaz7dvd.css' },
  lu_de: { ietf: 'de-LU', tk: 'vin7zsi.css', exl: 'de', base: 'de' },
  lu_en: { ietf: 'en-LU', tk: 'pps7abe.css', base: '' },
  lu_fr: { ietf: 'fr-LU', tk: 'vrk5vyv.css', exl: 'fr', base: 'fr' },
  hu: { ietf: 'hu-HU', tk: 'aaz7dvd.css' },
  mt: { ietf: 'en-MT', tk: 'pps7abe.css' },
  mena_en: { ietf: 'en', tk: 'pps7abe.css', base: '' },
  nl: { ietf: 'nl-NL', tk: 'cya6bri.css', exl: 'nl', base: '' },
  no: { ietf: 'no-NO', tk: 'aaz7dvd.css', base: '' },
  pl: { ietf: 'pl-PL', tk: 'aaz7dvd.css', base: '' },
  pt: { ietf: 'pt-PT', tk: 'inq1xob.css', exl: 'pt-br' },
  ro: { ietf: 'ro-RO', tk: 'aaz7dvd.css', base: '' },
  sa_en: { ietf: 'en', tk: 'pps7abe.css', base: '' },
  ch_de: { ietf: 'de-CH', tk: 'vin7zsi.css', exl: 'de', base: 'de' },
  si: { ietf: 'sl-SI', tk: 'aaz7dvd.css', base: '' },
  sk: { ietf: 'en-SK', tk: 'aaz7dvd.css', base: '' },
  ch_fr: { ietf: 'fr-CH', tk: 'vrk5vyv.css', exl: 'fr', base: 'fr' },
  fi: { ietf: 'fi-FI', tk: 'aaz7dvd.css', base: '' },
  se: { ietf: 'sv-SE', tk: 'fpk1pcd.css', exl: 'sv', base: '' },
  ch_it: { ietf: 'it-CH', tk: 'bbf5pok.css', exl: 'it', base: 'it' },
  tr: { ietf: 'tr-TR', tk: 'aaz7dvd.css', base: '' },
  ae_en: { ietf: 'en', tk: 'pps7abe.css', base: '' },
  uk: { ietf: 'en-GB', tk: 'pps7abe.css' },
  at: { ietf: 'de-AT', tk: 'vin7zsi.css', exl: 'de', base: 'de' },
  cz: { ietf: 'cs-CZ', tk: 'aaz7dvd.css', base: '' },
  bg: { ietf: 'bg-BG', tk: 'aaz7dvd.css', base: '' },
  ru: { ietf: 'ru-RU', tk: 'aaz7dvd.css', base: '' },
  ua: { ietf: 'uk-UA', tk: 'aaz7dvd.css', base: '' },
  ...
  cn: { ietf: 'zh-CN', tk: 'puu3xkp', exl: 'zh-hans', base: '' },
  ...
  vn_en: { ietf: 'en-GB', tk: 'pps7abe.css', base: '' },
